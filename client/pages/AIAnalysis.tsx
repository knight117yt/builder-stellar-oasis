...
export default function AIAnalysis() {
  ...
  const getRecommendationColor = (recommendation: string) => {
    switch (recommendation.toUpperCase()) {
      ...
      case "HOLD": return "text-trading-neutral";
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            {SYMBOLS.map((symbol) => (
              <Button
                key={symbol.value}
                variant={selectedSymbol.value === symbol.value ? "default" : "outline"}
                size="sm"
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-lg font-bold">{aiMetrics?.models_active || 4}</div>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-lg font-bold">
                  {analysisData ? `${(analysisData.analysis.confidence * 100).toFixed(0)}%` : "High"}
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Machine learning based trading signal</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className={cn(
                      ...
                      getRecommendationColor(analysisData?.analysis.recommendation || "HOLD")
                    )}>
                      {getRecommendationIcon(analysisData?.analysis.recommendation || "HOLD")}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">
                      {analysisData ? `${(analysisData.analysis.confidence * 100).toFixed(1)}%` : "85%"}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant={
                      analysisData?.analysis.trend === "bullish" ? "default" : "destructive"
                    }>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">
                      {analysisData ? `${(analysisData.analysis.strength * 100).toFixed(1)}%` : "78%"}
                    </span>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>AI calculated support and resistance</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div>
                    <div className="text-sm text-muted-foreground mb-2">Target Price:</div>
                    <div className="text-xl font-bold text-trading-bull">
                      ₹{analysisData?.analysis.price_target?.toFixed(2) || (currentPrice * 1.05).toFixed(2)}
                    </div>
                  </div>
                  
                  <div>
                    <div className="text-sm text-muted-foreground mb-2">Stop Loss:</div>
                    <div className="text-xl font-bold text-trading-bear">
                      ₹{analysisData?.analysis.stop_loss?.toFixed(2) || (currentPrice * 0.95).toFixed(2)}
                    </div>
                  </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>AI identified critical price levels</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="space-y-1">
                      {(analysisData?.analysis.resistance_levels || [currentPrice * 1.02, currentPrice * 1.04]).map((level, index) => (
                        <div key={index} className="text-sm font-mono text-trading-bear">
                          ₹{level.toFixed(2)}
                        </div>
                      ))}
                    </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      {(analysisData?.analysis.support_levels || [currentPrice * 0.98, currentPrice * 0.96]).map((level, index) => (
                        <div key={index} className="text-sm font-mono text-trading-bull">
                          ₹{level.toFixed(2)}
                        </div>
                      ))}
                    </div>
        ...
        <TabsContent value="technical" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>AI interpretation of technical indicators</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <div className="space-y-2">
                  ...
                  <div className="text-lg font-bold">
                    {analysisData?.analysis.technical_indicators?.rsi?.toFixed(1) || "55.2"}
                  </div>
                  <Badge variant="secondary">Neutral</Badge>
                </div>
                
                <div className="space-y-2">
                  <div className="text-sm text-muted-foreground">MACD Signal</div>
                  <div className="text-lg font-bold">
                    {analysisData?.analysis.technical_indicators?.macd_signal || "Bullish"}
                  </div>
                  <Badge variant="default">Strong</Badge>
                </div>
                
                <div className="space-y-2">
                  <div className="text-sm text-muted-foreground">Bollinger Position</div>
                  <div className="text-lg font-bold">
                    {analysisData?.analysis.technical_indicators?.bollinger_position || "Middle"}
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-lg font-bold">
                    {analysisData?.analysis.technical_indicators?.volume_trend || "Increasing"}
                  </div>
        ...
        <TabsContent value="sentiment" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>AI-powered sentiment from news, social media, and market data</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-2xl font-bold text-trading-bull">68%</div>
                  <Badge variant="default">Positive</Badge>
                </div>
                
                <div className="space-y-2">
                  <div className="text-sm text-muted-foreground">Social Media</div>
                  <div className="text-2xl font-bold text-trading-neutral">55%</div>
                  <Badge variant="secondary">Neutral</Badge>
                </div>
              </div>
            </CardContent>
              ...
              <div className="space-y-4">
                <div className="p-4 border rounded-lg bg-green-50 border-green-200">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-medium text-green-800">Bullish Momentum Detected</div>
                      <div className="text-sm text-green-700 mt-1">
                        Strong buying pressure observed with increasing volume. Consider long positions with proper risk management.
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 border rounded-lg bg-blue-50 border-blue-200">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-medium text-blue-800">Volume Analysis</div>
                      <div className="text-sm text-blue-700 mt-1">
                        Above-average volume confirms price movement. This increases the reliability of current trend signals.
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 border rounded-lg bg-yellow-50 border-yellow-200">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-medium text-yellow-800">Risk Alert</div>
                      <div className="text-sm text-yellow-700 mt-1">
                        Approaching resistance level. Monitor for potential reversal signals and adjust position sizes accordingly.
                      </div>
                    </div>
                  </div>
                </div>
